...
import { PvpShopService } from '../application/PvpShopService.js';
import { PVP_BUY_DESC, PVP_DESCRIPTION, PVP_ITEM_OPTION_DESC, PVP_SHOP_DESC } from '../../../shared/ui/text/pvp.js';
