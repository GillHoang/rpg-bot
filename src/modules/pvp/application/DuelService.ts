...
import { StatAssemblyService, type AssembledPlayer } from '../../combat-shared/application/StatAssemblyService.js';
...
import type { CombatantState } from '../../combat-shared/domain/CombatantState.js';
...
export interface DuelDependencies {
	...
	/** Shared combat preamble; individual engine/factory options take precedence when both are given. */
