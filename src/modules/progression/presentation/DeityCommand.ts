...
import { AscensionService } from '../application/AscensionService.js';
import { MAX_SIGILS } from '../../../shared/config/ascension.js';
import {
...
export class DeityCommand implements ICommand {
	...
	constructor(private readonly ascension: Pick<AscensionService, 'addSigil' | 'ascend'>) {}
