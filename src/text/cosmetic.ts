...
// --- Cosmetic: list ---
export const COSMETIC_NO_CHARACTER = 'Dùng /create trước.';
export const COSMETIC_LIST_HEADER = '🎨 **Cosmetics**';
...
export const COSMETIC_LOCK = (minLevel: number): string => ` · 🔒 cần believer level ${minLevel}`;
